...
$old = $old ?? [];
$values = [
    'cedula' => htmlspecialchars($old['cedula'] ?? ($integrante['cedula'] ?? '')),
    'nombre' => htmlspecialchars($old['nombre'] ?? ($integrante['nombre'] ?? '')),
    'apellido' => htmlspecialchars($old['apellido'] ?? ($integrante['apellido'] ?? '')),
    'correo' => htmlspecialchars($old['correo'] ?? ($integrante['correo'] ?? '')),
    'telefono' => htmlspecialchars($old['telefono'] ?? ($integrante['telefono'] ?? '')),
];
?>
...
<div class="container-fluid py-4">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
        <div>
            <h1 class="h3">Editar integrante</h1>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="?url=proyecto/actualizarIntegrante/<?= $proyecto['idProyecto'] ?>/<?= $integrante['idProyectista'] ?>" method="post">
                <div class="row g-3">
                    <div class="col-md-4">
